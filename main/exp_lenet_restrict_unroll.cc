...
int main() {
  ...
  dataset.read();
  std::cout << "Unroll LeNet-5 implementation" << std::endl;
  ...
  Network c_lenet5;
  Layer* c_conv1 = new RestrictUnrollConv(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* c_conv3 = new RestrictUnrollConv(6, 23, 23, 16, 5, 5, 1, 0, 0);
