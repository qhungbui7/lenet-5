...
#include "src/custom/restrict-unroll/restrict_unroll.h"
...
int main() {
  ...
  dataset.read();
  std::cout << "Restrict Unroll Convolution LeNet-5 implementation" << std::endl;
  ...
  Network lenet5;
  Layer* conv1 = new RestrictUnrollConv(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* conv3 = new RestrictUnrollConv(6, 23, 23, 16, 5, 5, 1, 0, 0);
