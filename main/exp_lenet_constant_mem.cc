...
int main() {
  ...
  dataset.read();
  std::cout << "Constant Memory Convolution LeNet-5 implementation" << std::endl;
  ...
  Network lenet5;
  Layer* conv1 = new ConstantMem(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* conv3 = new ConstantMem(6, 23, 23, 16, 5, 5, 1, 0, 0);
