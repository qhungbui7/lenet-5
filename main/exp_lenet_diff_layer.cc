...
#include "src/custom/diff-layer/diff_layer_conv.h"
...
int main() {
  ...
  dataset.read();
  std::cout << "Newer LeNet-5 implementation - Multiple kernel implementations for different layer sizes" << std::endl;
  ...
  Network lenet5;
  Layer* conv1 = new DiffLayerSizeConv(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* conv3 = new DiffLayerSizeConv(6, 23, 23, 16, 5, 5, 1, 0, 0);
