...
int main() {
  ...
  dataset.read();
  std::cout << "Different Layer LeNet-5 implementation" << std::endl;
  ...
  Network c_lenet5;
  Layer* c_conv1 = new DiffLayerSizeConv(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* c_conv3 = new DiffLayerSizeConv(6, 23, 23, 16, 5, 5, 1, 0, 0);
