...
int main() {
  ...
  dataset.read();
  std::cout << "Reduction Tree Convolution LeNet-5 implementation" << std::endl;
  ...
  Network c_lenet5;
  Layer* c_conv1 = new ReductionTreeConv(1, 28, 28, 6, 5, 5, 1, 0, 0);
  ...
  Layer* c_conv3 = new ReductionTreeConv(6, 23, 23, 16, 5, 5, 1, 0, 0);
