...
__global__ void kernel_flatten(float* kernel, int i3, int i2, int i1, int i0, int C, int K){
  return kernel[(i3) * (C * K * K) + (i2) * (K * K) + (i1) * (K) + i0];
}

__global__ void input_flatten(float* x, int i3, int i2, int i1, int i0, int C, int H, int W){
  return  x[(i3) * (C * H * W) + (i2) * (H * W) + (i1) * (W) + i0];
}

__global__ void output_flatten(float* y, int i3, int i2, int i1, int i0, int H_out, int W_out){
