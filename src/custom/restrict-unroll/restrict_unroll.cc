...
vector<float> RestrictUnrollConv::get_parameters() const
{
...
void RestrictUnrollConv::set_parameters(const vector<float> &param)
{
...
vector<float> RestrictUnrollConv::get_derivatives() const
{
