#include "restrict_unroll.h"
#include <math.h>
#include <iostream>

void RestrictUnrollConv::init()
{
...
void RestrictUnrollConv::forward(const Matrix &bottom)
{
...
void RestrictUnrollConv::backward(const Matrix &bottom, const Matrix &grad_top)
{
}

void RestrictUnrollConv::update(Optimizer &opt)
{
}

std::vector<float> RestrictUnrollConv::get_parameters() const
{
...
void RestrictUnrollConv::set_parameters(const std::vector<float> &param)
{
...
std::vector<float> RestrictUnrollConv::get_derivatives() const
{
