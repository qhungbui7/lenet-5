#ifndef SRC_RESTRICT_UNROLL_H_
#define SRC_RESTRICT_UNROLL_H_
...
class RestrictUnrollConv : public Layer
{
private:
     const int dim_in;
     int dim_out;
     ...
     GPURestrictUnrollInterface gpuInterface;

     void init();

public:
     RestrictUnrollConv(int channel_in, int height_in, int width_in, int channel_out,
