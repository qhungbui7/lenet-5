#include "reduction_tree_conv.h"
#include <math.h>
#include <iostream>

void ReductionTreeConv::init()
{
...
void ReductionTreeConv::forward(const Matrix &bottom)
{
...
void ReductionTreeConv::backward(const Matrix &bottom, const Matrix &grad_top)
{
}

void ReductionTreeConv::update(Optimizer &opt)
{
}

std::vector<float> ReductionTreeConv::get_parameters() const
{
...
void ReductionTreeConv::set_parameters(const std::vector<float> &param)
{
...
std::vector<float> ReductionTreeConv::get_derivatives() const
{
