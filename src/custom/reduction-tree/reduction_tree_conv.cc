...
vector<float> ReductionTreeConv::get_parameters() const
{
...
void ReductionTreeConv::set_parameters(const vector<float> &param)
{
...
vector<float> ReductionTreeConv::get_derivatives() const
{
