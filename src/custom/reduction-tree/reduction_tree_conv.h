#ifndef SRC_LAYER_BASIC_CONV_H_
#define SRC_LAYER_BASIC_CONV_H_
...
private:
     ...
     GPUReductionTreeInterface gpuInterface;

     void init();

public:
     ReductionTreeConv(int channel_in, int height_in, int width_in, int channel_out,
