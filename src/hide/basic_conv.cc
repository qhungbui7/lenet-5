...
void BasicConv::forward(const Matrix &bottom)
{
...
void BasicConv::backward(const Matrix &bottom, const Matrix &grad_top)
{
}

void BasicConv::update(Optimizer &opt)
{
}

std::vector<float> BasicConv::get_parameters() const
{
...
void BasicConv::set_parameters(const std::vector<float> &param)
{
...
std::vector<float> BasicConv::get_derivatives() const
{
